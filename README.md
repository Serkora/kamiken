...
Пока что ничего из этого не работает, конечно.
- Переработаны некоторые фукнции, теперь обработчик событий движения мышки всего лишь
вызывает нужные функции, в зависимсоти от состяния игры, так как кода в каждой из них
довольно прилична. Впрочем, это нужно чинить, так как он очень сильно повторяющийся.
То же самое будет сделано и для клика мыши. 
