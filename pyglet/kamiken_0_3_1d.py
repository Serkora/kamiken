...
class Slider(Control):
	def __init__(self, value, batch):
		self.THUMB_WIDTH = 6
		self.THUMB_HEIGHT = 10
		self.GROOVE_HEIGHT = 2
		self.value = value
		self.max = 100
		self.min = 0
		self.batch = batch
...
class Board(pyglet.window.Window):
	...
	def __init__(self, BOARD_W, BOARD_H, WINDOW_W, WINDOW_H, MSG, TILE_SIZE, SQUARE_SIZE, FONT):
		...
		self.slider = Slider(0, self.batch_startup)	
		self.startuplabels()
